...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/Cashmaney/cosmos-sdk/types/errors.Wrap",
		"github.com/Cashmaney/cosmos-sdk/types/errors.Wrapf",
		"github.com/Cashmaney/cosmos-sdk/types/errors.WithType",
