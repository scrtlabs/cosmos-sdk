...
type (
	...
	AppCreator func(sdk.SdkLogger, dbm.DB, io.Writer, AppOptions) Application
	...
	AppExporter func(sdk.SdkLogger, dbm.DB, io.Writer, int64, bool, []string, AppOptions) (ExportedApp, error)
)
