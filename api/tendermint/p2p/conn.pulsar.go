...
func init() {
	file_tendermint_p2p_conn_proto_init()
	md_PacketPing = File_tendermint_p2p_conn_proto.Messages().ByName("PacketPing")
}
...
func (x *fastReflection_PacketPing) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.p2p.PacketPing"))
		}
		panic(fmt.Errorf("message tendermint.p2p.PacketPing does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PacketPing) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message tendermint.p2p.PacketPing does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PacketPing) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in tendermint.p2p.PacketPing", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_tendermint_p2p_conn_proto_init()
	md_PacketPong = File_tendermint_p2p_conn_proto.Messages().ByName("PacketPong")
}
...
func (x *fastReflection_PacketPong) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.p2p.PacketPong"))
		}
		panic(fmt.Errorf("message tendermint.p2p.PacketPong does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PacketPong) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message tendermint.p2p.PacketPong does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PacketPong) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in tendermint.p2p.PacketPong", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_tendermint_p2p_conn_proto_init()
	md_PacketMsg = File_tendermint_p2p_conn_proto.Messages().ByName("PacketMsg")
...
func (x *fastReflection_PacketMsg) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "tendermint.p2p.PacketMsg.channel_id":
		return x.ChannelId != int32(0)
	case "tendermint.p2p.PacketMsg.eof":
		return x.Eof != false
	case "tendermint.p2p.PacketMsg.data":
		return len(x.Data) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.p2p.PacketMsg"))
		}
		panic(fmt.Errorf("message tendermint.p2p.PacketMsg does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PacketMsg) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message tendermint.p2p.PacketMsg does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PacketMsg) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "tendermint.p2p.PacketMsg.channel_id":
		panic(fmt.Errorf("field channel_id of message tendermint.p2p.PacketMsg is not mutable"))
	case "tendermint.p2p.PacketMsg.eof":
		panic(fmt.Errorf("field eof of message tendermint.p2p.PacketMsg is not mutable"))
	case "tendermint.p2p.PacketMsg.data":
		panic(fmt.Errorf("field data of message tendermint.p2p.PacketMsg is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.p2p.PacketMsg"))
		}
...
func (x *fastReflection_PacketMsg) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in tendermint.p2p.PacketMsg", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_tendermint_p2p_conn_proto_init()
	md_Packet = File_tendermint_p2p_conn_proto.Messages().ByName("Packet")
...
func (x *fastReflection_Packet) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "tendermint.p2p.Packet.packet_ping":
		if x.Sum == nil {
			return false
	...
	case "tendermint.p2p.Packet.packet_pong":
		if x.Sum == nil {
			return false
	...
	case "tendermint.p2p.Packet.packet_msg":
		if x.Sum == nil {
			return false
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.p2p.Packet"))
		}
		panic(fmt.Errorf("message tendermint.p2p.Packet does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Packet) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message tendermint.p2p.Packet does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Packet) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	case "tendermint.p2p.Packet.sum":
		if x.Sum == nil {
			return nil
		}
		switch x.Sum.(type) {
	...
	default:
		panic(fmt.Errorf("%s is not a oneof field in tendermint.p2p.Packet", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_tendermint_p2p_conn_proto_init()
	md_AuthSigMessage = File_tendermint_p2p_conn_proto.Messages().ByName("AuthSigMessage")
...
func (x *fastReflection_AuthSigMessage) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "tendermint.p2p.AuthSigMessage.pub_key":
		return x.PubKey != nil
	case "tendermint.p2p.AuthSigMessage.sig":
		return len(x.Sig) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.p2p.AuthSigMessage"))
		}
		panic(fmt.Errorf("message tendermint.p2p.AuthSigMessage does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_AuthSigMessage) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message tendermint.p2p.AuthSigMessage does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_AuthSigMessage) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "tendermint.p2p.AuthSigMessage.sig":
		panic(fmt.Errorf("field sig of message tendermint.p2p.AuthSigMessage is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.p2p.AuthSigMessage"))
		}
...
func (x *fastReflection_AuthSigMessage) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in tendermint.p2p.AuthSigMessage", d.FullName()))
	}
	panic("unreachable")
}
...
var file_tendermint_p2p_conn_proto_rawDesc = []byte{
	...
	0x69, 0x67, 0x42, 0x99, 0x01, 0x0a, 0x12, 0x63, 0x6f, 0x6d, 0x2e, 0x74, 0x65, 0x6e, 0x64, 0x65,
	0x72, 0x6d, 0x69, 0x6e, 0x74, 0x2e, 0x70, 0x32, 0x70, 0x42, 0x09, 0x43, 0x6f, 0x6e, 0x6e, 0x50,
