...
func init() {
	file_tendermint_p2p_pex_proto_init()
	md_PexRequest = File_tendermint_p2p_pex_proto.Messages().ByName("PexRequest")
}
...
func (x *fastReflection_PexRequest) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.p2p.PexRequest"))
		}
		panic(fmt.Errorf("message tendermint.p2p.PexRequest does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PexRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message tendermint.p2p.PexRequest does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PexRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in tendermint.p2p.PexRequest", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_tendermint_p2p_pex_proto_init()
	md_PexAddrs = File_tendermint_p2p_pex_proto.Messages().ByName("PexAddrs")
...
func (x *fastReflection_PexAddrs) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "tendermint.p2p.PexAddrs.addrs":
		return len(x.Addrs) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.p2p.PexAddrs"))
		}
		panic(fmt.Errorf("message tendermint.p2p.PexAddrs does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_PexAddrs) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message tendermint.p2p.PexAddrs does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_PexAddrs) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in tendermint.p2p.PexAddrs", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_tendermint_p2p_pex_proto_init()
	md_Message = File_tendermint_p2p_pex_proto.Messages().ByName("Message")
...
func (x *fastReflection_Message) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "tendermint.p2p.Message.pex_request":
		if x.Sum == nil {
			return false
	...
	case "tendermint.p2p.Message.pex_addrs":
		if x.Sum == nil {
			return false
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.p2p.Message"))
		}
		panic(fmt.Errorf("message tendermint.p2p.Message does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Message) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message tendermint.p2p.Message does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Message) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	case "tendermint.p2p.Message.sum":
		if x.Sum == nil {
			return nil
		}
		switch x.Sum.(type) {
	...
	default:
		panic(fmt.Errorf("%s is not a oneof field in tendermint.p2p.Message", d.FullName()))
	}
	panic("unreachable")
}
...
var file_tendermint_p2p_pex_proto_rawDesc = []byte{
	...
	,
