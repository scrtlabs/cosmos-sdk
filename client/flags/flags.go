...
func AddTxFlagsToCmd(cmd *cobra.Command) {
	...
	f.String(FlagFees, "", "Fees to pay along with transaction; eg: 1.0uscrt")
	f.String(FlagGasPrices, "0.25uscrt", "Gas prices in decimal format to determine the transaction fee (e.g. 0.1uscrt)")
