...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/enigmampc/cosmos-sdk/types/errors.Wrap",
		"github.com/enigmampc/cosmos-sdk/types/errors.Wrapf",
		"github.com/enigmampc/cosmos-sdk/types/errors.WithType",
