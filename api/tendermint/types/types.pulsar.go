...
var (
	...
	fd_Header_encrypted_random     protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Header_encrypted_random = md_Header.Fields().ByName("encrypted_random")
}
...
func (x *fastReflection_Header) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.EncryptedRandom != nil {
		value := protoreflect.ValueOfMessage(x.EncryptedRandom.ProtoReflect())
		if !f(fd_Header_encrypted_random, value) {
			return
		}
	}
}
...
func (x *fastReflection_Header) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "tendermint.types.Header.encrypted_random":
		return x.EncryptedRandom != nil
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Header) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "tendermint.types.Header.encrypted_random":
		x.EncryptedRandom = value.Message().Interface().(*EncryptedRandom)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.types.Header"))
		}
...
func (x *fastReflection_Header) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "tendermint.types.Header.encrypted_random":
		if x.EncryptedRandom == nil {
			x.EncryptedRandom = new(EncryptedRandom)
		}
		return protoreflect.ValueOfMessage(x.EncryptedRandom.ProtoReflect())
	case "tendermint.types.Header.chain_id":
...
func (x *fastReflection_Header) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.EncryptedRandom != nil {
			l = options.Size(x.EncryptedRandom)
			n += 1 + l + runtime.Sov(uint64(l))
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.EncryptedRandom != nil {
			encoded, err := options.Marshal(x.EncryptedRandom)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 15:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field EncryptedRandom", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if x.EncryptedRandom == nil {
					x.EncryptedRandom = &EncryptedRandom{}
				}
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.EncryptedRandom); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
var (
	md_EncryptedRandom        protoreflect.MessageDescriptor
	fd_EncryptedRandom_random protoreflect.FieldDescriptor
	fd_EncryptedRandom_proof  protoreflect.FieldDescriptor
)

func init() {
	file_tendermint_types_types_proto_init()
	md_EncryptedRandom = File_tendermint_types_types_proto.Messages().ByName("EncryptedRandom")
	fd_EncryptedRandom_random = md_EncryptedRandom.Fields().ByName("random")
	fd_EncryptedRandom_proof = md_EncryptedRandom.Fields().ByName("proof")
}

var _ protoreflect.Message = (*fastReflection_EncryptedRandom)(nil)

type fastReflection_EncryptedRandom EncryptedRandom

func (x *EncryptedRandom) ProtoReflect() protoreflect.Message {
	return (*fastReflection_EncryptedRandom)(x)
}

func (x *EncryptedRandom) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_EncryptedRandom_messageType fastReflection_EncryptedRandom_messageType
var _ protoreflect.MessageType = fastReflection_EncryptedRandom_messageType{}

type fastReflection_EncryptedRandom_messageType struct{}

func (x fastReflection_EncryptedRandom_messageType) Zero() protoreflect.Message {
	return (*fastReflection_EncryptedRandom)(nil)
}
func (x fastReflection_EncryptedRandom_messageType) New() protoreflect.Message {
	return new(fastReflection_EncryptedRandom)
}
func (x fastReflection_EncryptedRandom_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_EncryptedRandom
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_EncryptedRandom) Descriptor() protoreflect.MessageDescriptor {
	return md_EncryptedRandom
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_EncryptedRandom) Type() protoreflect.MessageType {
	return _fastReflection_EncryptedRandom_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_EncryptedRandom) New() protoreflect.Message {
	return new(fastReflection_EncryptedRandom)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_EncryptedRandom) Interface() protoreflect.ProtoMessage {
	return (*EncryptedRandom)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_EncryptedRandom) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.Random) != 0 {
		value := protoreflect.ValueOfBytes(x.Random)
		if !f(fd_EncryptedRandom_random, value) {
			return
		}
	}
	if len(x.Proof) != 0 {
		value := protoreflect.ValueOfBytes(x.Proof)
		if !f(fd_EncryptedRandom_proof, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_EncryptedRandom) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "tendermint.types.EncryptedRandom.random":
		return len(x.Random) != 0
	case "tendermint.types.EncryptedRandom.proof":
		return len(x.Proof) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.types.EncryptedRandom"))
		}
		panic(fmt.Errorf("message tendermint.types.EncryptedRandom does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_EncryptedRandom) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "tendermint.types.EncryptedRandom.random":
		x.Random = nil
	case "tendermint.types.EncryptedRandom.proof":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_EncryptedRandom) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "tendermint.types.EncryptedRandom.random":
		value := x.Random
		return protoreflect.ValueOfBytes(value)
	...
	default:
		...
		panic(fmt.Errorf("message tendermint.types.EncryptedRandom does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_EncryptedRandom) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "tendermint.types.EncryptedRandom.random":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_EncryptedRandom) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "tendermint.types.EncryptedRandom.random":
		panic(fmt.Errorf("field random of message tendermint.types.EncryptedRandom is not mutable"))
	case "tendermint.types.EncryptedRandom.proof":
		panic(fmt.Errorf("field proof of message tendermint.types.EncryptedRandom is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.types.EncryptedRandom"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_EncryptedRandom) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "tendermint.types.EncryptedRandom.random":
		return protoreflect.ValueOfBytes(nil)
	case "tendermint.types.EncryptedRandom.proof":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_EncryptedRandom) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in tendermint.types.EncryptedRandom", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_EncryptedRandom) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_EncryptedRandom) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_EncryptedRandom) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_EncryptedRandom) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*EncryptedRandom)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: EncryptedRandom: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: EncryptedRandom: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
type Header struct {
	...
	// encrypted random
	EncryptedRandom *EncryptedRandom `protobuf:"bytes,15,opt,name=encrypted_random,json=encryptedRandom,proto3" json:"encrypted_random,omitempty"` // a random number encrypted by the proposer to be used in contracts
}
...
func (x *Header) GetEncryptedRandom() *EncryptedRandom {
	if x != nil {
		return x.EncryptedRandom
	}
	return nil
}
...
func (x *EncryptedRandom) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EncryptedRandom) ProtoMessage() {}

// Deprecated: Use EncryptedRandom.ProtoReflect.Descriptor instead.
func (*EncryptedRandom) Descriptor() ([]byte, []int) {
	return file_tendermint_types_types_proto_rawDescGZIP(), []int{4}
}

func (x *EncryptedRandom) GetRandom() []byte {
	if x != nil {
		return x.Random
	}
	return nil
...
func (x *EncryptedRandom) GetProof() []byte {
	if x != nil {
		return x.Proof
	}
	return nil
...
var file_tendermint_types_types_proto_rawDesc = []byte{
	...
	0x72, 0x74, 0x53, 0x65, 0x74, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x22, 0xb4, 0x05, 0x0a, 0x06,
	...
	,
	...
	0x28, 0x05, 0x52, 0x05, 0x72, 0x6f, 0x75, 0x6e, 0x64, 0x12, 0x45, 0x0a, 0x08, 0x62, 0x6c, 0x6f,
	...
	0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09, 0x65, 0x78, 0x74,
	0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x2f, 0x0a, 0x13, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73,
	0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x18, 0x0a, 0x20,
	0x01, 0x28, 0x0c, 0x52, 0x12, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x53, 0x69,
	0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0xc0, 0x01, 0x0a, 0x06, 0x43, 0x6f, 0x6d, 0x6d,
	...
	0x12, 0x45, 0x0a, 0x08, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01,
	...
	0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x49, 0x64, 0x12, 0x41, 0x0a, 0x0a, 0x73, 0x69, 0x67, 0x6e, 0x61,
	0x74, 0x75, 0x72, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x74, 0x65,
	...
	0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x73, 0x22, 0xdd, 0x01, 0x0a, 0x09, 0x43,
	...
	0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x42, 0x0a, 0x09, 0x74, 0x69, 0x6d, 0x65,
	...
	0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0xe1, 0x01, 0x0a, 0x0e, 0x45,
	0x78, 0x74, 0x65, 0x6e, 0x64, 0x65, 0x64, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x12, 0x16, 0x0a,
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x72, 0x6f, 0x75, 0x6e, 0x64, 0x12, 0x45, 0x0a, 0x08, 0x62,
	0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e,
	0x74, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x74, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73,
	...
	,
	...
	0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73,
	...
	0x6e, 0x5f, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x0c, 0x52, 0x12, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x53, 0x69, 0x67, 0x6e,
	0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0xb3, 0x02, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73,
	0x61, 0x6c, 0x12, 0x33, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e,
	...
	0x6e, 0x64, 0x12, 0x45, 0x0a, 0x08, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x69, 0x64, 0x18, 0x05,
	...
	,
	...
	0x64, 0x61, 0x74, 0x6f, 0x72, 0x53, 0x65, 0x74, 0x22, 0xc2, 0x01, 0x0a, 0x09, 0x42, 0x6c, 0x6f,
	0x63, 0x6b, 0x4d, 0x65, 0x74, 0x61, 0x12, 0x45, 0x0a, 0x08, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f,
	...
	0x03, 0x52, 0x09, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x36, 0x0a, 0x06,
	...
	0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x6e, 0x75, 0x6d, 0x54, 0x78, 0x73, 0x22, 0x6a, 0x0a,
	...
	0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x2e, 0x0a, 0x05, 0x70, 0x72, 0x6f,
	...
	0x6f, 0x66, 0x52, 0x05, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x2a, 0xd7, 0x01, 0x0a, 0x0d, 0x53, 0x69,
	...
	0x70, 0x6f, 0x73, 0x61, 0x6c, 0x54, 0x79, 0x70, 0x65, 0x1a, 0x08, 0x88, 0xa3, 0x1e, 0x00, 0xa8,
	0xa4, 0x1e, 0x01, 0x42, 0xa6, 0x01, 0x0a, 0x14, 0x63, 0x6f, 0x6d, 0x2e, 0x74, 0x65, 0x6e, 0x64,
	0x65, 0x72, 0x6d, 0x69, 0x6e, 0x74, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x42, 0x0a, 0x54, 0x79,
...
var file_tendermint_types_types_proto_goTypes = []interface{}{
	...
	(*EncryptedRandom)(nil),       // 5: tendermint.types.EncryptedRandom
	...
	(*ExtendedCommit)(nil),        // 10: tendermint.types.ExtendedCommit
	(*ExtendedCommitSig)(nil),     // 11: tendermint.types.ExtendedCommitSig
...
var file_tendermint_types_types_proto_depIdxs = []int32{
	...
	5,  // 5: tendermint.types.Header.encrypted_random:type_name -> tendermint.types.EncryptedRandom
	0,  // 6: tendermint.types.Vote.type:type_name -> tendermint.types.SignedMsgType
	3,  // 7: tendermint.types.Vote.block_id:type_name -> tendermint.types.BlockID
	19, // 8: tendermint.types.Vote.timestamp:type_name -> google.protobuf.Timestamp
	3,  // 9: tendermint.types.Commit.block_id:type_name -> tendermint.types.BlockID
	9,  // 10: tendermint.types.Commit.signatures:type_name -> tendermint.types.CommitSig
	20, // 11: tendermint.types.CommitSig.block_id_flag:type_name -> tendermint.types.BlockIDFlag
	19, // 12: tendermint.types.CommitSig.timestamp:type_name -> google.protobuf.Timestamp
	3,  // 13: tendermint.types.ExtendedCommit.block_id:type_name -> tendermint.types.BlockID
	11, // 14: tendermint.types.ExtendedCommit.extended_signatures:type_name -> tendermint.types.ExtendedCommitSig
	20, // 15: tendermint.types.ExtendedCommitSig.block_id_flag:type_name -> tendermint.types.BlockIDFlag
	19, // 16: tendermint.types.ExtendedCommitSig.timestamp:type_name -> google.protobuf.Timestamp
	...
	4,  // 20: tendermint.types.SignedHeader.header:type_name -> tendermint.types.Header
	8,  // 21: tendermint.types.SignedHeader.commit:type_name -> tendermint.types.Commit
	13, // 22: tendermint.types.LightBlock.signed_header:type_name -> tendermint.types.SignedHeader
	21, // 23: tendermint.types.LightBlock.validator_set:type_name -> tendermint.types.ValidatorSet
	3,  // 24: tendermint.types.BlockMeta.block_id:type_name -> tendermint.types.BlockID
	4,  // 25: tendermint.types.BlockMeta.header:type_name -> tendermint.types.Header
	17, // 26: tendermint.types.TxProof.proof:type_name -> tendermint.crypto.Proof
