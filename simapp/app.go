...
import (
	...
	"github.com/enigmampc/cosmos-sdk/x/auth/ante"
	"github.com/enigmampc/cosmos-sdk/x/auth/vesting"
...
func NewSimApp(
	...
	govRouter.AddRoute(gov.RouterKey, gov.ProposalHandler).
		...
		AddRoute(distr.ProposalRouteSecretFoundationTax, distr.NewSecretFoundationTaxProposalHandler(app.DistrKeeper)).
