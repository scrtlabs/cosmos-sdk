...
type Params struct {
	...
	SecretFoundationTax     cosmossdk_io_math.LegacyDec `protobuf:"bytes,5,opt,name=secret_foundation_tax,json=secretFoundationTax,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"secret_foundation_tax"`
	SecretFoundationAddress string                      `protobuf:"bytes,6,opt,name=secret_foundation_address,json=secretFoundationAddress,proto3" json:"secret_foundation_address,omitempty"`
	MinimumRestakeThreshold cosmossdk_io_math.LegacyDec `protobuf:"bytes,7,opt,name=minimum_restake_threshold,json=minimumRestakeThreshold,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"minimum_restake_threshold"`
	RestakePeriod           cosmossdk_io_math.Int       `protobuf:"bytes,8,opt,name=restake_period,json=restakePeriod,proto3,customtype=cosmossdk.io/math.Int" json:"restake_period"`
}
...
var fileDescriptor_cd78a31ea281a992 = []byte{
	...
	,
}
