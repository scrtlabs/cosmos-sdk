...
1. Either [open](https://github.com/Cashmaney/cosmos-sdk/issues/new/choose) or
   [find](https://github.com/Cashmaney/cosmos-sdk/issues) an issue you'd like to help with
...
- Looking for a good place to start contributing? How about checking out some
  [good first issues](https://github.com/Cashmaney/cosmos-sdk/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
