...
func init() {
	file_tendermint_types_events_proto_init()
	md_EventDataRoundState = File_tendermint_types_events_proto.Messages().ByName("EventDataRoundState")
...
func (x *fastReflection_EventDataRoundState) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "tendermint.types.EventDataRoundState.height":
		return x.Height != int64(0)
	case "tendermint.types.EventDataRoundState.round":
		return x.Round != int32(0)
	case "tendermint.types.EventDataRoundState.step":
		return x.Step != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.types.EventDataRoundState"))
		}
		panic(fmt.Errorf("message tendermint.types.EventDataRoundState does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_EventDataRoundState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message tendermint.types.EventDataRoundState does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_EventDataRoundState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "tendermint.types.EventDataRoundState.height":
		panic(fmt.Errorf("field height of message tendermint.types.EventDataRoundState is not mutable"))
	case "tendermint.types.EventDataRoundState.round":
		panic(fmt.Errorf("field round of message tendermint.types.EventDataRoundState is not mutable"))
	case "tendermint.types.EventDataRoundState.step":
		panic(fmt.Errorf("field step of message tendermint.types.EventDataRoundState is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.types.EventDataRoundState"))
		}
...
func (x *fastReflection_EventDataRoundState) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in tendermint.types.EventDataRoundState", d.FullName()))
	}
	panic("unreachable")
}
...
var file_tendermint_types_events_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x73, 0x74, 0x65, 0x70, 0x42, 0xa7, 0x01, 0x0a, 0x14, 0x63,
	0x6f, 0x6d, 0x2e, 0x74, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x74, 0x2e, 0x74, 0x79,
	0x70, 0x65, 0x73, 0x42, 0x0b, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f,
