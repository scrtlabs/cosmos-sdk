...
var (
	...
	ErrInvalidSecretFoundationAddress = sdkerrors.Register(ModuleName, 13, "invalid secret foundation address")
	ErrInvalidSecretFoundationTax     = sdkerrors.Register(ModuleName, 14, "invalid secret foundation tax")
)
