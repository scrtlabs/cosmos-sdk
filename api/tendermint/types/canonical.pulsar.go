...
func init() {
	file_tendermint_types_canonical_proto_init()
	md_CanonicalVoteExtension = File_tendermint_types_canonical_proto.Messages().ByName("CanonicalVoteExtension")
...
func (x *fastReflection_CanonicalVoteExtension) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "tendermint.types.CanonicalVoteExtension.extension":
		return len(x.Extension) != 0
	case "tendermint.types.CanonicalVoteExtension.height":
		return x.Height != int64(0)
	case "tendermint.types.CanonicalVoteExtension.round":
		return x.Round != int64(0)
	case "tendermint.types.CanonicalVoteExtension.chain_id":
		return x.ChainId != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.types.CanonicalVoteExtension"))
		}
		panic(fmt.Errorf("message tendermint.types.CanonicalVoteExtension does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_CanonicalVoteExtension) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message tendermint.types.CanonicalVoteExtension does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_CanonicalVoteExtension) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "tendermint.types.CanonicalVoteExtension.extension":
		panic(fmt.Errorf("field extension of message tendermint.types.CanonicalVoteExtension is not mutable"))
	case "tendermint.types.CanonicalVoteExtension.height":
		panic(fmt.Errorf("field height of message tendermint.types.CanonicalVoteExtension is not mutable"))
	case "tendermint.types.CanonicalVoteExtension.round":
		panic(fmt.Errorf("field round of message tendermint.types.CanonicalVoteExtension is not mutable"))
	case "tendermint.types.CanonicalVoteExtension.chain_id":
		panic(fmt.Errorf("field chain_id of message tendermint.types.CanonicalVoteExtension is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: tendermint.types.CanonicalVoteExtension"))
		}
...
func (x *fastReflection_CanonicalVoteExtension) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in tendermint.types.CanonicalVoteExtension", d.FullName()))
	}
	panic("unreachable")
}
...
var file_tendermint_types_canonical_proto_rawDesc = []byte{
	...
	0x63, 0x68, 0x61, 0x69, 0x6e, 0x49, 0x64, 0x42, 0xaa, 0x01, 0x0a, 0x14, 0x63, 0x6f, 0x6d, 0x2e,
	0x74, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x74, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73,
	0x42, 0x0e, 0x43, 0x61, 0x6e, 0x6f, 0x6e, 0x69, 0x63, 0x61, 0x6c, 0x50, 0x72, 0x6f, 0x74, 0x6f,
